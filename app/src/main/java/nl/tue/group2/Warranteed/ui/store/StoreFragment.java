...
public class StoreFragment extends Fragment {
    ...
    private void updateStoreInfo() {
        FirebaseFirestore.getInstance().collection("Store").document(StoreHomeFragment.COOLGREEN_STORE_ID).get().addOnSuccessListener(result -> {
            // store name
    ...
    private void updateStoreImages() {
        View logoView = this.getActivity().findViewById(R.id.imageViewLogo), picture1View = this.getActivity()
                                                                                                .findViewById(R.id.imageView2), picture2View =
                this.getActivity()
                                                                                                                                                   .findViewById(
                                                                                                                                                           R.id.imageView3), picture3View = this
                .getActivity()
